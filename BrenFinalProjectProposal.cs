...
class Program
{
    ...
    static void RemoveItem()
    {
        ...
        if (item != null)
        {
            ...
            actions.Add($"[{DateTime.Now}] Removed Item: {item.Name} (PN: {productNumber})");
    ...
    static void LocateItem()
    {
        ...
        if (item != null)
        {
            ...
            Console.WriteLine("Price: P" + item.Price.ToString("F2"));
            Console.WriteLine("Stock: " + item.Stock);
            Console.WriteLine("Type: " + item.ProductType);
        }
        else
        {
            Console.WriteLine("Item not found!");
    ...
    static void SellItem()
    {
        ...
        {
            item.Stock -= quantity;
            actions.Add($"[{DateTime.Now}] Sold {quantity} of {item.Name} (PN: {productNumber})");
